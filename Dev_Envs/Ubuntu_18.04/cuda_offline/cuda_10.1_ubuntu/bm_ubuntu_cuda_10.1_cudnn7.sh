...
export BM_CUDNN_ZIP=cudnn-10.1-linux-x64-v7.6.5.32.tgz
## cuDNN v7.1 Runtime Library for Ubuntu16.04 (Deb)
export BM_CUDNN_RUNTIME_DEB=libcudnn7_7.6.5.32-1+cuda10.1_amd64.deb
## cuDNN v7.1 Developer Library for Ubuntu16.04 (Deb)
export BM_CUDNN_DEVLIB_DEB=libcudnn7-dev_7.6.5.32-1+cuda10.1_amd64.deb
## cuDNN v7.1 Code Samples and User Guide for Ubuntu16.04 (Deb)
export BM_CUDNN_DOC_DEB=libcudnn7-doc_7.6.5.32-1+cuda10.1_amd64.deb
